...
document.getElementById("casaDeLaLibertad").addEventListener("click", function() {
  window.location.href = "pages/casa-de-la-libertad.html" });
document.getElementById("miradorDeRecoleta").addEventListener("click", function() {
  window.location.href = "pages/mirador-de-recoleta.html" });
document.getElementById("parqueCretacico").addEventListener("click", function() {
  window.location.href = "pages/parque-cretacico.html" });
document.getElementById("castilloDeLaGlorieta").addEventListener("click", function() {
  window.location.href = "pages/castillo-de-la-glorieta.html" });
